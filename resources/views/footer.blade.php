    ...
    <div class="container">
        <div id="next-steps-copy" class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-3 d-flex justify-content-center bg-white pt-5 pb-3">
            ...
            <div class="next-step mt-3 mt-md-0 shadow">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSf4_kZvj9dTrKiiT2q4Ynq3ZJ2g1gZ6JQ0qNPUDFLrwaOkeew/viewform" target="_blank" class="btn-opacity"><div class="shadow btn btn-lg btn-redish btn-family">&#10097; Schedule A Trial!</div></a>            </div>
            <div class="next-step mt-3 mt-md-0 shadow">
...
<div id="bottom" class="text-white-50 text-center pt-3" style="background: black;">
    © 2024 Lindsey Claire Dance Company
</div>
